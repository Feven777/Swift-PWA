      ...
      <div className="bg-white border-b border-gray-200 py-6">
        <div className="container px-4 md:px-6 max-w-6xl mx-auto">
          ...
          <p className="text-gray-600 mb-4">
            Browse products available for delivery from {supermarket.name}
          </p>
          ...
          <div className="flex flex-wrap gap-2 mb-6">
            <DropdownMenu>
              ...
              <DropdownMenuContent>
                ...
                <DropdownMenuItem onClick={() => setSelectedCategory(2)}>
                  Dairy & Eggs
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => setSelectedCategory(3)}>
                  Meat & Seafood
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => setSelectedCategory(4)}>
                  Bakery
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => setSelectedCategory(5)}>
                  Frozen Foods
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => setSelectedCategory(6)}>
                  Beverages
                </DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent>
                ...
                <DropdownMenuItem onClick={() => setPriceFilter("Low to High")}>
                  Low to High
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => setPriceFilter("High to Low")}>
                  High to Low
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => setPriceFilter("On Sale")}>
                  On Sale
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => setPriceFilter("Under 50 Br")}>
                  Under 50 Br
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => setPriceFilter("50-100 Br")}>
                  50-100 Br
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => setPriceFilter("Over 100 Br")}>
                  Over 100 Br
                </DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
