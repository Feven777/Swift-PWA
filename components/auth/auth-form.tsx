          ...
          <TabsContent value="login">
            <form onSubmit={handleLoginSubmit} className="space-y-4">
              <div className="space-y-2">
                ...
                />
                {loginEmailError && <p className="text-sm font-medium text-destructive">{loginEmailError}</p>}
              </div>
              ...
              <div className="space-y-2">
                ...
                />
                {loginPasswordError && <p className="text-sm font-medium text-destructive">{loginPasswordError}</p>}
              </div>
          ...
          <TabsContent value="register">
            <form onSubmit={handleRegisterSubmit} className="space-y-4">
              <div className="space-y-2">
                ...
                />
                {registerNameError && <p className="text-sm font-medium text-destructive">{registerNameError}</p>}
              </div>
              ...
              <div className="space-y-2">
                ...
                />
                {registerEmailError && <p className="text-sm font-medium text-destructive">{registerEmailError}</p>}
              </div>
              ...
              <div className="space-y-2">
                ...
                {registerPasswordError && (
                  <p className="text-sm font-medium text-destructive">{registerPasswordError}</p>
                )}
              </div>
