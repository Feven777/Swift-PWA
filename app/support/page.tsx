                ...
                <CardContent>
                  <Accordion type="single" collapsible className="w-full">
                    <AccordionItem value="item-1">
                      ...
                      <AccordionContent>
                        You can track your order by going to the "Your Orders"
                        section in your profile. Click on "View details" for the
                        specific order you want to track. You'll see real-time
                    ...
                    <AccordionItem value="item-2">
                      ...
                      <AccordionContent>
                        If you won't be home during delivery, you can select
                        "Contactless Delivery" in your preferences. The driver
                        will leave your order at your door. You can also add
                        delivery instructions when placing your order.
                      </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="item-3">
                      ...
                      <AccordionContent>
                        You can modify or cancel your order within 30 minutes of
                        placing it. Go to "Your Orders," find the order you want
                        to change, and click "View details." From there, you can
                        make changes or cancel if eligible.
                      </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="item-4">
                      ...
                      <AccordionContent>
                        ...
                        size. Orders over $35 qualify for free delivery. You can
                        see the exact delivery fee during checkout before
                ...
                <CardContent>
                  <Accordion type="single" collapsible className="w-full">
                    <AccordionItem value="item-1">
                      ...
                      <AccordionContent>
                        If you're not satisfied with any product, you can
                        request a refund within 24 hours of delivery. For
                        perishable items, please report any issues immediately
                        upon delivery.
                      </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="item-2">
                      ...
                      <AccordionContent>
                        To report missing or damaged items, go to "Your Orders,"
                        select the affected order, and click "View details."
                        Then select "Report an issue" and follow the
                        instructions. Our support team will review your request
                        within 24 hours.
                      </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="item-3">
                ...
                <CardContent>
                  <Accordion type="single" collapsible className="w-full">
                    <AccordionItem value="item-1">
                      ...
                      <AccordionContent>
                        To update your payment information, go to "Settings" in
                        your profile, then select "Payment Methods." From there,
                        you can add, edit, or remove payment methods.
                      </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="item-2">
                      <AccordionTrigger>
                      ...
                      <AccordionContent>
                        Yes, we take security seriously. All personal and
                        payment information is encrypted and stored securely. We
                    ...
                    <AccordionItem value="item-3">
                      ...
                      <AccordionContent>
                        To change your email or password, go to "Settings" in
                        your profile, then select "Account Information." You can
          ...
          <div className="py-6 text-center">
            ...
            <div className="flex justify-center space-x-4">
              <Button
                variant="outline"
                onClick={() => {
                  // this would use the tel: protocol
